...
export function Sidebar({
  ...
  selectedTables,
  onToggleTable,
  onToggleAll, // Updated to match usage in App.jsx but in Sidebar definition it was onSelectAll. 
  // Wait, in App.jsx: <Sidebar ... onSelectAll={toggleAll} />
  // In Message dump: export function Sidebar({ ... onSelectAll })
  // In the usage inside Sidebar: onClick={onSelectAll}
  // So I should stick to onSelectAll.
  onSelectAll
}) {
